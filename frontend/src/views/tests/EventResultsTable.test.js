...
test('Sets Chosen Course If Provided', () => {
  const wrapper = mount(ResultsTable, {
    mocks: {
  ...
  expect(wrapper.vm.chosenCourse).toBe('Hello')
})
