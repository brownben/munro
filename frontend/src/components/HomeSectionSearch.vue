<template>
  <section
    class="w-full py-8 text-white md:py-10 lg:py-14 bg-gradient-to-r from-main-600 to-main-500"
  >
    <div
      class="flex flex-col items-center max-w-screen-xl px-6 mx-auto text-center sm:px-12 lg:px-8"
    >
      <h2
        class="text-4xl leading-tight tracking-tighter md:mb-2 md:text-5xl font-heading"
      >
      ...
      >
        ...
        <input
          ...
          type="text"
          spellcheck="false"
          class="w-full py-2 pl-10 pr-24 font-sans leading-snug text-white transition duration-300 ease-in-out bg-transparent border outline-none appearance-none border-main-300 focus:border-white rounded-shape focus:shadow-outline-white"
