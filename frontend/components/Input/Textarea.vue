...
<template>
  <div>
    ...
    <textarea
      ...
      :value="modelValue"
      :type="type"
      class="w-full rounded-sm border bg-transparent p-2 text-sm text-gray-900 ring-offset-2 transition focus:outline-hidden focus-visible:ring-2 dark:text-gray-100 dark:ring-offset-gray-800"
      :class="{
