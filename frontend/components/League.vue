...
<template>
  <article>
    ...
    <p class="pt-2 leading-tight text-gray-600 sm:text-xl dark:text-gray-400">
      {{ league.tagline }}
    </p>

    <NuxtLink
      :to="`/leagues/${league.name}`"
      class="text-main-700 hover:text-main-600 dark:text-main-600 dark:hover:text-main-500 mt-6 inline-block"
    >
      View details →
    </NuxtLink>
  </article>
