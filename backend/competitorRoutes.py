...
class Competitors(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return {'message': 'Competitor - {} was Created'.format(data['name'])}
        except:
            return {'message': 'Error: Problem Creating Competitor - Please Try Again'}, 500
    ...
    def put(self, competitorId):
        ...
        try:
            competitors.updateCompetitor(
                data['id'], data['name'], data['ageClass'], data['club'], data['course'], data['league'])
            return {'message': 'Competitor - {} was Updated'.format(data['name'])}
        except:
